...
@section('content-body')
    <div class="row">
        <div class="col-md-12 col-xs-12"><!-- PAGE CONTENT BEGINS -->
            <div class="row">
                <div class="col-xs-12">
                    <a href="{{ route('marital.create') }}"><span class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Baru</span></a>
                    <br><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                        <form action="{{ route('marital.destroy', $row->id) }}" method="post">
                                            @csrf
                                            {{ method_field('DELETE') }}
                                            <a href="{{ route('marital.edit', $row->id) }}" class="btn btn-xs btn-info">
