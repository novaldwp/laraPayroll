...
@section('content-body')
    <div class="row">
        <div class="col-md-12 col-xs-12"><!-- PAGE CONTENT BEGINS -->
            <div class="row">
                <div class="col-xs-12">
                    <form id="form-validation" class="form-horizontal" method="POST" action="{{ route('marital.update', $marital->id) }}">
                        @csrf
                        {{ method_field('PUT') }}
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name" placeholder="Nama Status Pernikahan" value="{{ $marital->name }}" class="form-control" autocomplete="off" required/>
                            </div>
                        </div>
